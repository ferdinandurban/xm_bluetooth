...
public class BluetoothService {
    ...
    private static final UUID UUID_ANDROID_DEVICE = UUID.fromString("6E6B5C64-FAF7-40AE-9C21-D4933AF45B23");
    ...
    private BluetoothStatus mState;
    ...
    public BluetoothService(Context context, Handler handler) {
        ...
        mState = BluetoothStatus.STATE_NONE;
        mHandler = handler;
    }
    ...
    public synchronized void start(boolean isAndroid) {
        ...
        setState(BluetoothStatus.STATE_LISTEN);
    ...
    public synchronized void connect(BluetoothDevice device) {
        // Cancel any thread attempting to make a connection
        if (mState == BluetoothStatus.STATE_CONNECTING) {
            if (mConnectThread != null) {mConnectThread.cancel(); mConnectThread = null;}
        }
        ...
        setState(BluetoothStatus.STATE_CONNECTING);
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        setState(BluetoothStatus.STATE_CONNECTED);
    }
    ...
    public synchronized void stop() {
        ...
        setState(BluetoothStatus.STATE_NONE);
    }
    ...
    public void write(byte[] out) {
        ...
        synchronized (this) {
            if (mState != BluetoothStatus.STATE_CONNECTED) return;
            r = mConnectedThread;
        }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != BluetoothStatus.STATE_CONNECTED && isRunning) {
                try {
