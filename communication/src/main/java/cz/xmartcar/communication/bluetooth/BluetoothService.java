...
public class BluetoothService {
    ...
    private static final UUID MY_UUID_SECURE = UUID.fromString("137A2365-D360-4C90-8E92-87742816B044");
    private static final UUID MY_UUID_INSECURE = UUID.fromString("806F33CB-8FFC-4971-B311-63D9BFDA62D6");
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                ...
                log.error("Socket Type: " + mSocketType + "listen() failed", e);
            }
            mmServerSocket = tmp;
        }

        public void run() {
            log.debug("Socket Type: " + mSocketType + "BEGIN mAcceptThread" + this);
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    log.error("Socket Type: " + mSocketType + "accept() failed", e);
                        ...
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                ...
                                try {
                                    ...
                                    log.error("Could not close unwanted socket", e);
                                }
                                break;
                        }
                    }
        ...
        public void cancel() {
            log.debug("Socket Type" + mSocketType + "cancel " + this);
            try {
                mmServerSocket.close();
            } catch (IOException e) {
                log.error("Socket Type" + mSocketType + "close() of server failed", e);
            }
        }
    }
